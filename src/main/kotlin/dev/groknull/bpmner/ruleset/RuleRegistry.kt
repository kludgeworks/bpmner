 ...
 * `@Bean LlmRuleSpec` beans — see [dev.groknull.bpmner.ruleset.internal.domain.InMemoryRuleRegistry]
 * and [dev.groknull.bpmner.ruleset.internal.domain.beans.BeanRuleRegistry].
 *
...
interface RuleRegistry {
     ...
     * [dev.groknull.bpmner.ruleset.internal.domain.beans.BeanRuleRegistry].
     */
