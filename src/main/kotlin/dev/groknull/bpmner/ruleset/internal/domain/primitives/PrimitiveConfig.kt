 ...
 * `src/main/kotlin/dev/groknull/bpmner/rules/internal/domain/beans/` (each `*RuleConfig.kt`
 * file defines one config type). They are hand-authored rather than generated by
...
/**
 * Pkl-side mirror of [dev.groknull.bpmner.ruleset.internal.domain.nlp.PosTag]. Lives in this
