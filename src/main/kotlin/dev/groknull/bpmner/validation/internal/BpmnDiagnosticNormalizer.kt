package dev.groknull.bpmner.validation.internal
...
internal class BpmnDiagnosticNormalizer {
    ...
    fun graphDiagnostic(graph: LaidOutProcessGraph, message: String): BpmnDiagnostic =
        scopedDiagnostic(
            graph = graph,
            diagnostic = BpmnDiagnostic(
    ...
    fun scopedDiagnostic(graph: LaidOutProcessGraph, diagnostic: BpmnDiagnostic): BpmnDiagnostic {
    ...
    private fun inferRepairScope(diagnostic: BpmnDiagnostic, ownerRef: String?): BpmnRepairScope {
