...
internal class BpmnReadinessPromptFactory(
    ...
    fun prompt(request: BpmnRequest): String =
        buildString {
            ...
            appendGroundingRules()
            appendVerdictRules()
            appendDimensionGuidance()
            appendVocabAndQuestions()
            appendInputContext(request)
        }
    ...
    private fun StringBuilder.appendGroundingRules() {
    ...
    private fun StringBuilder.appendVerdictRules() {
    ...
    private fun StringBuilder.appendVocabAndQuestions() {
    ...
    private fun StringBuilder.appendInputContext(request: BpmnRequest) {
