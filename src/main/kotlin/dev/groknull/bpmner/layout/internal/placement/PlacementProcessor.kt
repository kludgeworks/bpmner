 ...
 *
 * Every coordinate mutation of a flow-node shape that is a declared move (i.e. the one declared
 * moving convention, [CollaborationFramePlacement]) must record a [MoveRecord] in [moves] so the
