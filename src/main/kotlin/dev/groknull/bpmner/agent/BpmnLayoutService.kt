...
/**
 * Service that applies auto-layout to BPMN XML using the bundled JS library.
 */
@Service
class BpmnLayoutService {
    ...
    /**
     * Applies auto-layout to the provided [xml].
     * Returns the layouted XML string.
     */
    fun layout(xml: String): String {
        ...
        return try {
            ...
            xml // Return original XML on failure
        }
    }
