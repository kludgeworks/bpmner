...
internal class BpmnRepairPromptFactory(
    ...
    fun patchFeedback(definition: BpmnDefinition, diagnostics: List<BpmnDiagnostic>): String = buildString {
    ...
    fun targetedLabelPatchFeedback(definition: BpmnDefinition, diagnostics: List<BpmnDiagnostic>): String {
