...
data class GitHubCatalogEntry(val id: String, val publisher: String)
...
object GitHubCatalogClient {
    ...
    fun fetchTextModels(catalogUrl: String = "https://models.github.ai/catalog/models"): List<GitHubCatalogEntry> = try {
    ...
    internal fun parseTextModels(json: String): List<GitHubCatalogEntry> = try {
