...
internal class ActivityRuleConfig {
    ...
    fun actActivityLabelCapitalization(nlp: BpmnNlp): BpmnRule = primitiveRule(
        ...
        targetElements = listOf("bpmn:Task", "bpmn:SubProcess", "bpmn:CallActivity"),
        errorMessages = mapOf(
    ...
    fun actVerbObjectName(nlp: BpmnNlp): BpmnRule = compositeRule(
        ...
        sub(
            ...
            PartOfSpeechCheckConfig(
                ...
                posClass = dev.groknull.bpmner.rules.internal.domain.primitives.NlpPosTag.VERB,
            ),
        )
        targetTypes("bpmn:Task", "bpmn:SubProcess", "bpmn:CallActivity")
    }
}
