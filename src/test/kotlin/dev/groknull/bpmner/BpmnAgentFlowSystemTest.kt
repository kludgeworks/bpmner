...
class BpmnAgentFlowSystemTest : EmbabelMockitoIntegrationTest() {
    ...
    fun `interactive needs-clarification pauses for clarification input`() {
        ...
        // The planner reaching a WAITING state is this test's concern. That the pause is also
        // delivered to a subscriber as an AWAITING_INPUT update is BpmnRunUpdateDeliveryTest's.
