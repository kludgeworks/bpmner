 ...
 *
 * BootstrapMode.ALL_DEPENDENCIES (intentional; see ADR-006 gate 4‴ rationale): `pipeline`
 ...
 * `pipeline.internal.adapter.inbound` (ADR-006 Track A) and resolves without a stub.
 * API keys are stubbed so no live LLM call is made at startup.
 * (S7 — ADR-006 gate 4‴ ALL_DEPENDENCIES rationale; ARCHITECTURE §5 S7, G8; §1.8 pipeline)
 */
