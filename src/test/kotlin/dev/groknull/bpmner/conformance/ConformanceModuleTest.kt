 ...
 *
 * BootstrapMode.DIRECT_DEPENDENCIES (ADR-006 gate 4‴): `BpmnLoggingConfig` and `BpmnConformanceConfig`
 ...
 * module. [dev.groknull.bpmner.ruleset.internal.config.ConventionsLoader.bpmnerLintConfig] is guarded with
 * `@ConditionalOnMissingBean` so no stub
