...
class DeterministicPrimitivesTest {
    ...
    @Test
    fun `property pattern forbiddenVocabulary flags words case-insensitively independent of regex`() {
        val ctx = context(
            nodes = listOf(
    ...
    @Test
    fun `property pattern allowedVocabulary scrubs allowed words before regex evaluation`() {
        val ctx = context(
            nodes = listOf(
    ...
    @Test
    fun `property pattern allowedVocabulary does not mask forbiddenVocabulary hits`() {
