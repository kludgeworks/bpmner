# KLM BPMN AI Style Rules

Author: Rovo Chat (AI assistant)  
Scope: BPMN modeling within KLM Operations (KLOps)  
Primary sources:
- **2.1 – BPMN Toolbox**  
  https://afklm.atlassian.net/wiki/spaces/BPM/pages/188483501/2.1+-+BPMN+Toolbox
- **4.1 – Naming conventions for BPMN models in KLOps**  
  https://afklm.atlassian.net/wiki/spaces/BPM/pages/187668405/4.1+-+Naming+conventions+for+BPMN+models+in+KLOps

---

## 1. General Principles

**GEN‑01 – Use only the KLOps BPMN subset**

- **For modellers:**  
  Use only the BPMN elements described in the *KLOps BPMN Toolbox* (activities, events, gateways, pools/lanes, connecting objects, artifacts, data elements). Avoid other “exotic” BPMN 2.0 elements.
- **For AI:**  
...
- **For modellers:**  
  ...
  - Avoid vague verbs such as `Handle` where a more specific one exists (see verb list page: https://afklm.atlassian.net/wiki/spaces/BPM/pages/187636531).
- **For AI:**  
...
- **For AI:**  
  - Flag overly generic or unclear labels like `KLM Employee`, `Cleaning`.  
