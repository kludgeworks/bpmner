...
This template outlines the mandatory and optional information required to generate a high-quality, valid BPMN 2.0 model for KLM Operations.
...
- **Primary Pool**: Usually the organization (e.g., "KLM Operations").
