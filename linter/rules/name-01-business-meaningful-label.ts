...
const TECHNICAL_TOKENS = new Set([ 'api', 'svc', 'tbl', 'req', 'resp', 'tmp', 'proc', 'obj' ]);
...
export = function() {
  function check(node: ModdleElement, reporter: Reporter) {
    ...
    if (seemsTechnical(name)) {
      reporter.report(node.id, 'Label appears technical/cryptic; prefer business-meaningful wording');
    }
  }
