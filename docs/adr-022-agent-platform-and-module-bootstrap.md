# ADR-022: Agent platform wiring & module-test bootstrap
...
Origin: epic #424 S7 (agent-platform & bootstrap decisions); config-registration decision reversed by #451 S4 (see ADR-451 S4). See `architecture.md` §5.
